...
const camera = THREE_UTILS.getPerspectiveCamera({fov: 60, near: 1, far: 50}, windowSizes)
...
const update = THREE_UTILS.getUpdateFunction([
    ...
    (time) => {
        ...
        if(!motion_callback){
            ...
            turtle.group.rotateOnAxis(new THREE.Vector3(1, 0, 0), UTILS.randomUniform(-Math.PI / 2, Math.PI / 2))
